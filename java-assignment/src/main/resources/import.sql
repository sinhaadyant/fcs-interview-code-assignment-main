...
ALTER SEQUENCE IF EXISTS store_seq RESTART WITH 4;
...
ALTER SEQUENCE IF EXISTS product_seq RESTART WITH 4;
...
ALTER SEQUENCE IF EXISTS warehouse_seq RESTART WITH 4;
